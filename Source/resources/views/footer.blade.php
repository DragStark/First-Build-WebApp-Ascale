    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="/danh-muc/10-iphone.html" class="stext-107 cl7 hov-cl1 trans-04">
                            iPhone
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="/danh-muc/13-imac.html" class="stext-107 cl7 hov-cl1 trans-04">
                            iMac
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="/danh-muc/12-macbook.html" class="stext-107 cl7 hov-cl1 trans-04">
                            MacBook
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="/danh-muc/11-ipad.html" class="stext-107 cl7 hov-cl1 trans-04">
                            iPad
                        </a>
                    </li>
                </ul>
